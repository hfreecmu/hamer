...
def reform_pred_list(pred_list):
    ...
    ### harry
    results_mano = {}
    results_mano['mano.right'] = [rots_r, trans_r, pose_r, shape_r]
    results_mano['mano.left'] = [rots_l, trans_l, pose_l, shape_l]
    ### harry
...
def main():
    ...
    args.img_folder = os.path.join(args.seq_name, 'undistorted')
    ...
    ### harry
    out_mano_p = op.join(args.img_folder, '../processed/mano.npy')
    out_mano_p = op.normpath(out_mano_p)
